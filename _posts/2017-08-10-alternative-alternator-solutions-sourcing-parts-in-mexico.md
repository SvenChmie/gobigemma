...
We could probably figure out how to rebuild our alternator if we could find a shop that could run some other tests for us and do the pressing. However, our lack of knowledge _did_ make us nervous, like it usually does when we are faced with [repairs of this size](http://gobigemma.de/2016/07/06/will-not-defeated/). All of this meant that the safer option was to get the alternator itself instead of just the bearing.
