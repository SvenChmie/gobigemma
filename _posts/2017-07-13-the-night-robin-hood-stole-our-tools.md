---
layout: post
title: "The Night Robin Hood Stole our Tools in Mexico"
date: 2017-07-13
categories: 
...
As far as I know, this isn't a movie or TV show yet (But maybe [soon](http://www.imdb.com/title/tt4532826/)?), but it would fit perfectly into the line of recent years' action blockbusters (has anyone seen [_Hansel and Gretel: Witchhunters_](http://www.imdb.com/title/tt1428538/)?). Robin Hood steals and robs his way through the modern-day world, but he's a hero. Even if his actions are against the so-called "law", he helps to make the world a little fairer. The needle of our moral compass points deep into the "righteous" side, the fact that Robin's actions are illegal is merely a sign of how screwed up the world he lives in is.
...
\[caption id="attachment\_2289" align="aligncenter" width="702"\]![Big Emma at the scene of the crime]({{ site.baseurl }}/assets/images/Big_Emma_Outside-1024x450.jpg) The scene of the crime, in daylight, a few days before the break-in.\[/caption\]

He takes a closer look and opens a small vent window on the driver side with a screwdriver. He reaches inside the to roll down the window, while his armor shimmers in the faint moonlight. He pulls up the knob to unlock the door and tries to open it. The lock clicks, but the door doesn't open. What is going on? He has a brief look around but cannot find the reason why the door won't open. Okay, through the window then. Our hero elegantly climbs in and begins to inspect the rich _gringos_' belongings. A few minutes later, he walks away with his booty: a propane tank, a toolbox filled to the brim with tools, two pairs of shoes, a fan, and an extension cord.

### Falling prey to the Prince of Thieves

You might have guessed it, this is not a poor attempt to write a script for a superhero movie. You also probably realized that the "van" our hero has entered so elegantly is Big Emma, while we are cast for the role of the "rich _gringos_". Why am I telling you all this? You'll see. First, let's dive back in and see how we - the rich _gringos_ - find out what has happened.
...
\[caption id="attachment\_2793" align="alignleft" width="297"\]![Reinforced vent windows]({{ site.baseurl }}/assets/images/Vent_Window_Protection-297x300.jpg) Reinforced vent windows. Open that, Robin!\[/caption\]
...
\[caption id="attachment\_2792" align="aligncenter" width="702"\]![Locks against Robin Hood]({{ site.baseurl }}/assets/images/New_Locks-1024x399.jpg) Ramped-up security. Let's at least make it a challenge next time.\[/caption\]
...
\[caption id="attachment\_2805" align="aligncenter" width="702"\]![Sunrise bus]({{ site.baseurl }}/assets/images/Cool_Car-1024x510.jpg) Nice sunrise bus\[/caption\]
